...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno)
    {
        ...
        ((AbstractDocument) textPan.getDocument()).setDocumentFilter(new LengthFilter(10));
        add(textPan);
        ...
        ((AbstractDocument) textAadhar.getDocument()).setDocumentFilter(new LengthFilter(12));
        add(textAadhar);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (pan.length() != 10 || !pan.matches("[A-Z0-9]{10}")) {
            JOptionPane.showMessageDialog(this, "Enter a valid 10-character PAN Number (Uppercase letters & numbers only).", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (aadhar.length() != 12 || !aadhar.matches("\\d{12}")) {
            JOptionPane.showMessageDialog(this, "Enter a valid 12-digit Aadhar Number.", "Error", JOptionPane.ERROR_MESSAGE);
            return;}
